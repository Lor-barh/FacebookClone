...
<nav class="container-fluid" id="main-nav-user-home">
    <div class="row">
        <div class="col-md-6" id="user-tools-left">
            <a href="home.jsp" id="main-logo">C</a>
            <div id="search-box">
        ...
        <div class="col-md-6" id="user-tools-right">
            <ul>
                <li>
                    <a href="./profile.jsp"><img class="avatar24" src="./img/atlantic-3929616_640.jpg">Johny</a>
                </li>
                <li>
                        ...
                        <div class="col-md-8 profile-body-content-editing">
                            ...
                            <div class="overview-form">
                                <form action="/" method="post">
                                    ...
                                    <input type="radio" name="sex" id="female"> <label class="light"
